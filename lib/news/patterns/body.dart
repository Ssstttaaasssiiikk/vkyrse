  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      NewsPost(
          ...
          dateText: dateText,
          imageLocation:
              "https://storage.tusur.ru/files/161710/1024-686/01.png"),
      NewsPost(
          headText:
          ...
          dateText: dateText,
          imageLocation:
              "https://storage.tusur.ru/files/161703/1024-686/01.png"),
      NewsPost(
          headText:
          ...
          dateText: dateText,
          imageLocation:
              "https://storage.tusur.ru/files/161672/1024-686/01.jpg"),
      NewsPost(
          headText:
          ...
          dateText: dateText,
          imageLocation:
              "https://storage.tusur.ru/files/161660/1024-686/01.jpg"),
      NewsPost(
          headText:
          ...
          dateText: dateText,
          imageLocation:
              "https://storage.tusur.ru/files/161653/1024-686/01.png"),
    ]));
  }
}
